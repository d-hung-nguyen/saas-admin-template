...
const apiEndpoints: APIEndpoint[] = [
  ...
  // Add these agent endpoints after the customer endpoints:
  {
    method: "GET",
    path: "/api/agents",
    ...
    responses: [
      {
        ...
        description: "Returns an array of agent objects with agency information",
      },
    ],
  },
  {
    ...
    parameters: [
      ...
      },
      {
        ...
        type: "string",
        required: true,
        description: "Role of the agent (agent, hotel_admin, regional_admin, global_admin)",
      },
      {
        name: "agency_id",
        type: "string",
        required: false,
        description: "ID of the agency the agent belongs to",
      },
      {
        name: "first_name",
        type: "string",
    ...
    responses: [
      {
        ...
        description: "Returns an agent object with agency information",
      },
    ],
  },
  {
  ...
  // Continue with existing subscription endpoints...
  {
    method: "GET",
    path: "/api/subscriptions",
    description: "Retrieve a list of all subscriptions",
