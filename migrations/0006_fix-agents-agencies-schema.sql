-- Migration number: 0006 	 2025-08-06T18:38:56.843Z

-- First, let's create agencies table with proper structure
...
-- Create agents table (drop and recreate if it exists with wrong structure)
